...
public class MessageConstant {
    ...
    public static final String GET_USERLIMIT_SUCCESS = "查询用户菜单权限成功";
    public static final String GET_USERLIMIT_FAIL = "查询用户菜单权限失败";
    public static final String GET_USERINFO_SUCCESS = "查询全部用户信息成功";
    public static final String GET_ROLEINFO_SUCCESS = "查询角色信息成功";
    public static final String GET_USERINFO_FAIL = "查询全部用户信息失败";
    public static final String GET_MENUINFO_SUCCESS = "查询菜单信息成功";
    public static final String GET_MENUINFO_FAIL = "查询菜单信息失败";
    public static final String GET_ROLEINFO_FAIL = "查询角色信息失败";
    ...
    public static final String JUDGEUSER_YES = "用户存在";
    public static final String JUDGEUSER_NO = "用户不存在";
    public static final String JUDGEROLE_YES = "角色存在";
    public static final String JUDGEROLE_NO = "角色不存在";
    public static final String ADD_ROLEINFO_SUCCESS = "添加角色信息成功";
    public static final String ADD_ROLEINFO_FAIL = "添加角色信息失败";
    ...
    public static final String GET_PERMISSION_SUCCESS = "获取权限名称成功";
    public static final String GET_PERMISSION_FAIL = "获取权限名称失败";
